...
"color: rgb(255, 255, 255);")
        ...
        self.fft_end_l = QtWidgets.QLabel(self.resynth_wid)
        self.fft_end_l.setMinimumSize(QtCore.QSize(80, 0))
        self.fft_end_l.setMaximumSize(QtCore.QSize(80, 16777215))
        self.fft_end_l.setAlignment(QtCore.Qt.AlignCenter)
        self.fft_end_l.setObjectName("fft_end_l")
        self.horizontalLayout_7.addWidget(self.fft_end_l)
        self.fft_end_dsb = QtWidgets.QDoubleSpinBox(self.resynth_wid)
        self.fft_end_dsb.setMinimumSize(QtCore.QSize(64, 0))
        self.fft_end_dsb.setFrame(False)
        self.fft_end_dsb.setAlignment(QtCore.Qt.AlignCenter)
        self.fft_end_dsb.setButtonSymbols(QtWidgets.QAbstractSpinBox.NoButtons)
        self.fft_end_dsb.setDecimals(3)
        self.fft_end_dsb.setMinimum(0.0)
        self.fft_end_dsb.setMaximum(1.0)
        self.fft_end_dsb.setSingleStep(0.1)
        self.fft_end_dsb.setProperty("value", 1.0)
        self.fft_end_dsb.setObjectName("fft_end_dsb")
        self.horizontalLayout_7.addWidget(self.fft_end_dsb)
...
"Overrides loop points"))
        ...
        self.fft_start_l.setText(_translate("loop_tool_mw", "FFT Start"))
        self.fft_start_dsb.setToolTip(_translate("loop_tool_mw", "Start of FFT analysis in percent of of input audio length"))
        self.fft_end_l.setText(_translate("loop_tool_mw", "FFT End"))
        self.fft_end_dsb.setToolTip(_translate("loop_tool_mw", "FFT analysis end in percent of of input audio length\n"
"\n"
"The shorter the FFT size the coarser, more \"noise-like\" the result\n"
